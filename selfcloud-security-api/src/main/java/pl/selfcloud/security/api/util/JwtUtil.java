...
public class JwtUtil {
  ...
  public String generateToken(DefaultOAuth2User oAuth2User) {
  ...
  public String generateToken(Map<String, Object> extraClaims, DefaultOAuth2User oAuth2User) {
    return buildToken(extraClaims, oAuth2User, jwtExpiration);
  }
